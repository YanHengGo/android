...
void queryRuntimeInfo(JNIEnv *env, jobject instance) {
    LOGI(" ......gentest FromC　queryRuntimeInfo start.....");
    ...
    LOGI(" ......FromC　queryRuntimeInfo end.....");
}
...
void*  UpdateTicks(void* context) {
    LOGI(" ......gentest FromC　UpdateTicks start.....");
    ...
    sendJavaMsg(env,pctx->jniHelperObj,statusId, "gentest from jni");
    ...
    LOGI(" ......gentest FromC　UpdateTicks end.....");
    return context;
}
